...
def process_sprite_group(sprite_group, canvas):
    sprite_groupc = set(sprite_group)
...
def rock_spawner():
    ...
    rock_vel[0] = rock_vel[0] + rock_vel[0] * score / 30
    rock_vel[1] = rock_vel[1] + rock_vel[1] * score / 30
    a_rock = Sprite(rock_pos, rock_vel, 0, rock_avel, asteroid_image, asteroid_info)
    if len(rock_group) <= 12 and dist(my_ship.get_position(), a_rock.get_position()) > my_ship.get_radius() + a_rock.get_radius():
